			...
			<form name="info" action=info_update.jsp method=get onSubmit="return validateForm();">
				<table>
					...
					<tr>
						...
						<td colspan = "2">
							<select name = "dept_No">
								...
								<option value = "10" <%if(dept_No.equals("10")) {%>selected<%} %>>인사팀</option>
								<option value = "20" <%if(dept_No.equals("20")) {%>selected<%} %>>재무팀</option>
								<option value = "30" <%if(dept_No.equals("30")) {%>selected<%} %>>기획팀</option>
							</select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class = "addr">
							<input type = "text" name=jibun_addr id=jibun_addr style = "width: 300px;" value="<%=DBjibun_addr%>">
						</td>
					</tr>
					<tr>
